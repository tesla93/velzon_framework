...
export const orderTrackingHistory: IOrderTrackingHistory[] = [
    ...
    {id: '4', orderId: '54', createdDateTime: new Date(), orderTrackingTimelineStatus: OrderTrackingTimelineStatusEnum.Complete, timelineLabel: 'In route to Warehouse',},
    {id: '5', orderId: '54', createdDateTime: new Date(), orderTrackingTimelineStatus: OrderTrackingTimelineStatusEnum.Current, timelineLabel: 'In Route to Airport',},
    {id: '6', orderId: '54', createdDateTime: new Date(), orderTrackingTimelineStatus: OrderTrackingTimelineStatusEnum.Future, timelineLabel: 'Arrived to Airport',},
    {id: '7', orderId: '54', createdDateTime: new Date(), orderTrackingTimelineStatus: OrderTrackingTimelineStatusEnum.Future, timelineLabel: 'In Air Transit',},
